...
import { Shield, Zap, Globe, Code, Lock, CheckCircle, ArrowRight, ChevronDown } from "lucide-react";
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <span className="text-xs font-medium text-primary">Blockchain-Secured Escrow Widget</span>
            </motion.div>
            ...
            >
              <span className="text-[hsl(0,0%,95%)]">TrustLock</span>
              <br />
              <motion.span
            ...
            >
              ...
              Embed trust directly into any vendor website — powered by Azix's smart contract
              infrastructure and the TrustLock Pay checkout experience.
            </motion.p>
            ...
            >
              <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}>
                ...
                >
                  Start Free Integration <ArrowRight className="ml-1 w-4 h-4" />
                </Button>
              </motion.div>
              <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}>
                <Button
                  size="lg"
                  className="rounded-full px-8 border-2 border-[hsl(160,15%,18%)] text-[hsl(0,0%,95%)] bg-transparent hover:bg-[hsl(160,15%,15%)] hover:border-primary/30 transition-all duration-300 gap-2"
                  onClick={() => navigate("/test-widget")}
                >
