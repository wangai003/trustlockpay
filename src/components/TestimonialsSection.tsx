...
const promises = [
  { icon: Shield, title: "Buyer & Vendor Protection", text: "Every transaction is held in escrow with milestone-based release. Buyers don't pay until conditions are met; vendors see guaranteed funds before shipping." },
  { icon: Lock, title: "Blockchain-Verified Proofs", text: "Every escrow event — from payment lock to document upload to final release — is anchored on-chain, creating an immutable audit trail." },
  { icon: Globe, title: "Any Corridor, Any Currency", text: "Whether it's Dallas to Lagos, London to Shenzhen, or Dubai to Nairobi — TrustLock handles multi-currency settlement and compliance." },
