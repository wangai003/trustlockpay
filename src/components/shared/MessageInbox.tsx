...
const MessageInbox = ({ role, transactionId, transactionLabel }: MessageInboxProps) => {
  ...
  return (
    <div className="h-[calc(100dvh-14rem)] sm:h-[calc(100dvh-12rem)] min-h-[300px] border border-border rounded-lg bg-background overflow-hidden flex flex-col touch-auto">
