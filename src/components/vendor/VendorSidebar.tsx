...
const baseNavItems = [
  ...
  { label: "Repayments", icon: ClipboardList, to: "/trustlock/vendor/repayments", tip: "Log and track offline repayment confirmations", tlId: "TL-V-SB-NAV-REPAYMENTS", badgeKey: null },
