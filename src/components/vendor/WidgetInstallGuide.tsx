...
const PLATFORM_GUIDES: Record<string, PlatformGuide> = {
  Shopify: {
    steps: [
      ...
      { title: "Paste the widget code", detail: "Scroll to the bottom. Find the closing body tag. Paste the TrustLock code on the line ABOVE it" },
  ...
  WooCommerce: {
    steps: [
      ...
      { title: "Paste the widget code", detail: "Find the closing body tag at the bottom. Paste the TrustLock code on the line ABOVE it" },
...
const DEFAULT_GUIDE: PlatformGuide = {
  steps: [
    ...
    { title: "Locate the closing body tag", detail: "Scroll to the very bottom of your HTML and find the closing body tag" },
    { title: "Paste the widget code above it", detail: "Copy the code below and paste it on the line just above the closing body tag" },
    { title: "Save your changes", detail: "Click Save or Publish. Your TrustLock widget will be live!" },
  ],
