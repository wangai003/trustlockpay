...
import {
  ...
  ShieldCheck, FileText, BarChart3, Bot, Settings, LogOut, Shield, Menu, X, GitBranch, Banknote, Info, BookOpen, Tag, Landmark, MessageSquare, Fuel, ClipboardList, FlaskConical, Building2, Activity, Network, Inbox, UsersRound
} from "lucide-react";
...
const allNavItems = [
  ...
  { label: "Vendors", icon: Users, to: "/trustlock/admin/vendors", tip: "Manage vendor accounts, KYC, and tiers", moduleKey: "vendors", badgeKey: null },
  { label: "Buyers", icon: UserCheck, to: "/trustlock/admin/buyers", tip: "View buyer accounts and order history", moduleKey: "buyers", badgeKey: null },
  { label: "Compliance", icon: ShieldCheck, to: "/trustlock/admin/compliance", tip: "AML/KYC flags and regulatory compliance", moduleKey: "compliance", badgeKey: null },
  { label: "Analytics", icon: BarChart3, to: "/trustlock/admin/analytics", tip: "Revenue, volume, and platform performance charts", moduleKey: "analytics", badgeKey: null },
  { label: "Reports", icon: FileText, to: "/trustlock/admin/reports", tip: "Generate and export summary reports", moduleKey: "reports", badgeKey: null },
  { label: "Platform Analytics", icon: Activity, to: "/trustlock/admin/platform-analytics", tip: "Fund flow, funnels, adoption, and geographic insights", moduleKey: "analytics", badgeKey: null },
  { label: "Documents", icon: FileText, to: "/trustlock/admin/documents", tip: "Archived files, contracts, and evidence", moduleKey: "documents", badgeKey: null },
  ...
  // Messaging items — dynamically filtered below
  ...
  { label: "Client Inbox", icon: Inbox, to: "/trustlock/admin/messages", tip: "View and respond to all vendor and buyer messages", moduleKey: "messages", badgeKey: null },
