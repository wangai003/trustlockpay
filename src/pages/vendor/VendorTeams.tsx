                  ...
                  {selectedWs.invite_code && (
                    <div className="flex items-center gap-3 p-3 rounded-lg border border-primary/20 bg-primary/5">
                      <div className="flex-1">
                        <p className="text-xs font-semibold">Team Invite Link</p>
                        <p className="text-[11px] text-muted-foreground">Share this code with team members. They sign up as vendor/buyer, then join using this code.</p>
