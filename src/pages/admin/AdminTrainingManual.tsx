...
import { Download, FileText, ExternalLink, Scale, DollarSign, Shield, Clock, Upload, CheckCircle, AlertTriangle, Users, BookOpen } from "lucide-react";
                ...
                <AccordionContent className="space-y-3 text-sm text-muted-foreground">
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      { name: "IT Department", desc: "Consolidated IT — transaction monitoring, milestone verification, vendor/buyer accounts, platform config, blockchain proofs, gas treasury, system health, autonomous fixer triage, and code defect relay." },
                    ].map(d => (
