...
const SandboxLenderOverview = lazy(() => import("./pages/sandbox/SandboxLenderOverview"));
        ...
        <BrowserRouter>
          <Suspense fallback={<Loading />}>
            <Routes>
              ...
              <Route path="/sandbox/lender" element={<SandboxLayout />}>
                <Route index element={<SandboxLenderOverview />} />
              </Route>
