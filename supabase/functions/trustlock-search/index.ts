...
const knowledgeBase: Record<string, string> = {
  "escrow": "TrustLock escrow works by locking buyer funds in a smart contract until delivery is confirmed. The buyer pays → funds are held → vendor ships → buyer confirms → funds release. If no confirmation within the industry-adaptive auto-release window (14–90 days depending on industry), auto-release triggers. Buyers can request up to 3 extensions of 14 days each. For milestone-based transactions, funds release per completed milestone stage.",
  "auto-release": "The auto-release window is industry-adaptive: E-commerce/Freelance (14 days), Food & Beverage/Education (30 days), Logistics/Agriculture/Textiles (45 days), Manufacturing/Energy/Aviation (60 days), Construction/Real Estate (90 days). After a vendor marks an order as shipped, the buyer must confirm delivery or file a dispute before the window expires. Buyers receive reminder notifications at 7 days, 3 days, and 1 day before auto-release. Buyers can request up to 3 extensions of 14 days each to accommodate shipping delays.",
