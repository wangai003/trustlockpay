...
const knowledgeBase: Record<string, string> = {
  ...
  "os-payout": "TrustLock OS Pay handles fund withdrawals via local bank, mobile money, or crypto. It includes country-specific field requirements, fee calculation, and confirmation tracking. Supports both local and diaspora payout modes.",
